...
class ___VARIABLE_sceneName___RouterTests: XCTestCase {
    ...
    private class ___VARIABLE_sceneName___DataStoreMock: ___VARIABLE_sceneName___DataStore {
    ...
    func testSomething() {
        ...
        router = ___VARIABLE_sceneName___Router(viewController: viewController, dataStore: ___VARIABLE_sceneName___DataStoreMock())
